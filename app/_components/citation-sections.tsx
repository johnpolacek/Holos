// Footnote link component used inline in content; maps superscript numbers to footer IDs.
export function FootnoteLink({ number }: { number: number }) {
...
export const citationSections: CitationSection[] = [
  {
    number: 1,
    id: "footer-life",
